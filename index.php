          ...
          <div class="container text-center text-md-left">
              ...
              <div class="row text-center text-md-left mt-3 pb-3">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 mx-auto mt-3">
                      ...
                      <p>Aplikasi pembuat pesan enkripsi chipper key dengan Caesar Chipper ini dibuat untuk memenuhi tugas mata kuliah Kriptografi dan Steganografi</p>
                  </div>
                  <!--/.First column-->
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 mx-auto mt-3">
                      ...
                      <i class="fa fa-home"></i>Universitas Mecu Buana, Meruya Utara, Jakarta Barat. Jakarta<br/>
                      <i class="fa fa-envelope"></i> anjasdwi.id@gmail.com
              ...
              <div class="row d-flex align-items-center">
                  ...
                  <div class="col-md-8 col-lg-8">
                      <!--Copyright-->
                      <p class="text-center text-md-left grey-text">© 2018 Copyright Anjas Dwi - 41515110104</p>
                      <!--/.Copyright-->
                  </div>
                  <!--Grid column-->
              </div>
